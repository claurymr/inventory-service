...
public class AdjustInventoryEntryCommandHandlerTests
{
    ...
    private readonly Mock<IValidator<AdjustInventoryEntryCommand>> _validatorMock;
    private readonly Mock<IEventBus> _eventBusMock = new();
    private readonly AdjustInventoryEntryCommandHandler _handler;

    public AdjustInventoryEntryCommandHandlerTests()
    {
        ...
        _validatorMock = _fixture.Freeze<Mock<IValidator<AdjustInventoryEntryCommand>>>();
        _handler = new AdjustInventoryEntryCommandHandler(_inventoryRepositoryMock.Object,
    ...
    public async Task Handle_ShouldAdjustInventory_WhenRequestIsValid()
    {
        ...
        inventoryHistory.NewQuantity.Should().Be(110);
